...
export class SubtitleDisplay extends BaseScriptComponent {
  ...
  private setTextStyle() {
    ...
    // Note: These properties may vary based on Spectacles text component capabilities
    this.subtitleText.outlineSize = 2;
    this.subtitleText.outlineColor = new vec4(0, 0, 0, 1); // Black outline
  }
